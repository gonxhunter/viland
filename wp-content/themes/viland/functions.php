...
function stn_frontend_scripts() {
    ...
    wp_enqueue_style( 'bootstrap-select',   get_template_directory_uri() . '/js/bootstrap-select/bootstrap-select.min.css');
    ...
    wp_enqueue_script( 'bootstrap-select',   get_template_directory_uri() . '/js/bootstrap-select/bootstrap-select.min.js');
