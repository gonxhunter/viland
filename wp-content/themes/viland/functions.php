...
function stn_frontend_scripts() {
    /*============ Styles ============ */
    wp_enqueue_style( 'bootstrap-select',   get_template_directory_uri() . '/js/bootstrap-select/bootstrap-select.css');
    ...
    wp_enqueue_script( 'bootstrap-select-js',   get_template_directory_uri() . '/js/bootstrap-select/bootstrap-select.min.js');
