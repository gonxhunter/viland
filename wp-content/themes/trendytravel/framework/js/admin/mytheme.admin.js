...
var mythemeAdmin = {
  init : function(){
    ...
    mythemeAdmin.addPrice();
    mythemeAdmin.removePrice();
    ...
    if( $ptemplate_select.length ) {
		$ptemplate_select.live('change', function(){
			...
			switch($val){
				...
				case 'tpl-hotels.php':
					$ptemplate_box.find('span:first').text('Hotels Options');
			        $ptemplate_box.slideDown();					
					$ptemplate_box.find('#tpl-common-settings').slideDown();
					$ptemplate_box.find('#tpl-hotels').slideDown();
          			$ptemplate_box.find("#page-commom-sidebar").slideDown();
					$ptemplate_box.find("#page-layout").slideDown();
				...
				case 'tpl-places.php':
					$ptemplate_box.find('span:first').text('Places Options');
			        $ptemplate_box.slideDown();					
					$ptemplate_box.find('#tpl-common-settings').slideDown();
					$ptemplate_box.find('#tpl-places').slideDown();
          			$ptemplate_box.find("#page-commom-sidebar").slideDown();
					$ptemplate_box.find("#page-layout").slideDown();
  ...
  addPrice : function() {
    jQuery(".add-price-item").click(function(event) {
      $parent = jQuery(this).parents(".smodule-price");
      $clone = jQuery(this).siblings(".clone").find(".smodule-price-container").clone();
      console.log( $clone );
  ...
  removePrice : function(){
    jQuery("body").delegate(".remove-price-item","click",function(event){
      jQuery(this).parents(".smodule-price-container").remove();
      event.preventDefault();
    });
  } //Remove Price
