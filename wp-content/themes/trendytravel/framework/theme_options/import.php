                    ...
                    <?php foreach($avail_demos as $avail_demo_key => $avail_demo) { ?>
                    		<div class="dttheme-demos <?php echo esc_attr($avail_demo_key); ?>-demo hide">
                                ...
                                <div class="column two-third last">
			                        ...
			                        <a class="lnk-onlinedemo" href="http://wedesignthemes.com/themes/trendy-travel/" target="_blank"><?php esc_html_e('Online Demo', 'iamd_text_domain');?></a>
                                </div>
                                <div class="hr_invisible"> </div>
                                ...
                                <div class="row-content hide">
                                    ...
                                    <div class="column two-third last">
                                        <select name="content" class="medium dt-chosen-select">
                                            ...
                                            <option value="packages"><?php esc_html_e('Packages', 'iamd_text_domain');?></option>
                                            <option value="hotels"><?php esc_html_e('Hotels', 'iamd_text_domain');?></option>
                                            <option value="rooms"><?php esc_html_e('Rooms', 'iamd_text_domain');?></option>
                                            <option value="places"><?php esc_html_e('Places', 'iamd_text_domain');?></option>
