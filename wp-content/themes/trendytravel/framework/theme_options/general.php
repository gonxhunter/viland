            ...
            <div class="bpanel-box">
                    ...
                    <div class="box-content">
                      ...
                      <div class="column one-fifth">
                        ...
                        <h6><?php _e('Google Map Api Key','iamd_text_domain');?></h6>
                        <div class="column one-half">
                            <input id="mytheme-google-api-key" name="mytheme[general][google-api-key]" type="text" value="<?php echo dt_theme_option('general','google-api-key'); ?>" />
                        </div>

                        <div class="column one-half last">
                            <p class="note no-margin"><?php _e('Paste your google api key that will be used for hotels & places map.','iamd_text_domain'); ?></p>
                        </div>
                    </div>
            </div><!-- .bpanel-box end-->
        </div><!--#my-general end-->
