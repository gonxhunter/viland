 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme TrendyTravel for publication on ThemeForest
...
function dt_theme_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			'name'     				=> 'LayerSlider Responsive WordPress Slider Plugin',
			'slug'     				=> 'LayerSlider',
	 ...
	 */
	$config = array(
		'id'           => 'iamd_text_domain',                 // Unique ID for hashing notices for multiple instances of TGMPA.
		...
		'strings'      => array(
			...
			'installing'                      => __( 'Installing Plugin: %s', 'iamd_text_domain' ),
			/* translators: %s: plugin name. * /
			'updating'                        => __( 'Updating Plugin: %s', 'iamd_text_domain' ),
			...
			'activated_successfully'          => __( 'The following plugin was activated successfully:', 'iamd_text_domain' ),
			/* translators: 1: plugin name. * /
			'plugin_already_active'           => __( 'No action taken. Plugin %1$s was already active.', 'iamd_text_domain' ),
			/* translators: 1: plugin name. * /
			'plugin_needs_higher_version'     => __( 'Plugin not activated. A higher version of %s is needed for this theme. Please update the plugin.', 'iamd_text_domain' ),
			/* translators: 1: dashboard link. * /
			'complete'                        => __( 'All plugins installed and activated successfully. %1$s', 'iamd_text_domain' ),
			'dismiss'                         => __( 'Dismiss this notice', 'iamd_text_domain' ),
			'notice_cannot_install_activate'  => __( 'There are one or more required or recommended plugins to install, update or activate.', 'iamd_text_domain' ),
			'contact_admin'                   => __( 'Please contact the administrator of this site for help.', 'iamd_text_domain' ),
