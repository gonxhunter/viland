...
function dt_theme_enqueue_scripts() {
	...
	wp_register_script('jq-html5', 'http'.dt_theme_ssl().'://html5shiv.googlecode.com/svn/trunk/html5.js', array(), '3.6.2', true);
	...
	if(is_singular('dt_hotels') || is_singular('dt_places')):
		$args = array( 'key' => dt_theme_option('general', 'google-api-key'), 'callback' => 'initMap' );
